...
always @(posedge clk) begin
	case (prog_ctr)
		...
		10'h004: instr_mem_out <= 16'h95FF; // LDI x5, 0xFF
		...
		10'h010: instr_mem_out <= 16'h6857; // COMPARE x7, x5
		10'h011: instr_mem_out <= 16'h8018; // JMPEQ add_IT_MEM_UPPER
		10'h012: instr_mem_out <= 16'h0000; // NOP
		10'h013: instr_mem_out <= 16'h0000; // NOP
		10'h014: instr_mem_out <= 16'h0000; // NOP
		10'h015: instr_mem_out <= 16'hBB08; // UNRLL x3, m0
		10'h016: instr_mem_out <= 16'h4B76; // RSTORE x3, x6, x7
		10'h017: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1 - Jump target for label: ADD_IT_MEM_UPPER
		10'h018: instr_mem_out <= 16'h3806; // JMP ADD_LOOP
		...
		10'h021: instr_mem_out <= 16'h4B76; // RSTORE x3, x6, x7
		10'h022: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1
		10'h023: instr_mem_out <= 16'h9002; // LDI x0, 0x02
		10'h024: instr_mem_out <= 16'h6806; // COMPARE x6, x0
		10'h025: instr_mem_out <= 16'h7806; // JMPLT ADD_LOOP - Jump target for label: MUL_LOOP
		...
		10'h02E: instr_mem_out <= 16'h0000; // NOP
		10'h02F: instr_mem_out <= 16'hA8AA; // MULM m0, m2, m2
		10'h030: instr_mem_out <= 16'h9A1A; // ADDM m2, m2, x1
		10'h031: instr_mem_out <= 16'hC308; // UNRLU x3, m0
		10'h032: instr_mem_out <= 16'h4B76; // RSTORE x3, x6, x7
		10'h033: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1
		10'h034: instr_mem_out <= 16'h6857; // COMPARE x7, x5
		10'h035: instr_mem_out <= 16'h8038; // JMPEQ mul_IT_MEM_UPPER
		10'h036: instr_mem_out <= 16'h0000; // NOP
		10'h037: instr_mem_out <= 16'h0000; // NOP - Jump target for label: MUL_IT_MEM_UPPER
		10'h038: instr_mem_out <= 16'h0000; // NOP
		10'h039: instr_mem_out <= 16'hBB08; // UNRLL x3, m0
		10'h03A: instr_mem_out <= 16'h4B76; // RSTORE x3, x6, x7
		10'h03B: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1
		10'h03C: instr_mem_out <= 16'h3826; // JMP MUL_LOOP
		10'h03D: instr_mem_out <= 16'h0000; // NOP
		10'h03E: instr_mem_out <= 16'h0000; // NOP
		10'h03F: instr_mem_out <= 16'h0000; // NOP
		10'h041: instr_mem_out <= 16'h0000; // NOP
		10'h042: instr_mem_out <= 16'h0E16; // ADD x6, x6, x1
		10'h043: instr_mem_out <= 16'h9700; // LDI x7, 0x00
		10'h044: instr_mem_out <= 16'hBB08; // UNRLL x3, m0
		10'h045: instr_mem_out <= 16'h4B76; // RSTORE x3, x6, x7 - Jump target for label: UART_OUT
		10'h046: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1
		10'h047: instr_mem_out <= 16'h9005; // LDI x0, 0x05
		10'h048: instr_mem_out <= 16'h6806; // COMPARE x6, x0
		10'h049: instr_mem_out <= 16'h7826; // JMPLT MUL_LOOP
		10'h04A: instr_mem_out <= 16'h0000; // NOP
		10'h04B: instr_mem_out <= 16'h0000; // NOP
		10'h04C: instr_mem_out <= 16'h0000; // NOP
		10'h051: instr_mem_out <= 16'h9600; // LDI x6, 0x00
		10'h052: instr_mem_out <= 16'h9700; // LDI x7, 0x00
		10'h054: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h055: instr_mem_out <= 16'h0000; // NOP
		10'h056: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h057: instr_mem_out <= 16'h8046; // JMPEQ UART_OUT - Jump target for label: UART_IT_MEM_UPPER
		10'h058: instr_mem_out <= 16'h0000; // NOP
		10'h059: instr_mem_out <= 16'h0000; // NOP
		10'h05A: instr_mem_out <= 16'h0000; // NOP
		10'h05B: instr_mem_out <= 16'h6857; // COMPARE x7, x5
		10'h05C: instr_mem_out <= 16'h8058; // JMPEQ UART_IT_MEM_UPPER
		10'h05D: instr_mem_out <= 16'h0000; // NOP
		10'h05E: instr_mem_out <= 16'h4376; // RLOAD x3, x6, x7
		10'h05F: instr_mem_out <= 16'h0000; // NOP
		10'h060: instr_mem_out <= 16'hD301; // OUTPUT x3, 0x01
		10'h061: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1
		10'h062: instr_mem_out <= 16'h3846; // JMP UART_OUT
		10'h063: instr_mem_out <= 16'h0000; // NOP
		10'h064: instr_mem_out <= 16'h0000; // NOP
		10'h065: instr_mem_out <= 16'h0000; // NOP
		10'h067: instr_mem_out <= 16'h0000; // NOP - Jump target for label: ADD_OUT_END
		10'h068: instr_mem_out <= 16'h0E16; // ADD x6, x6, x1
		10'h069: instr_mem_out <= 16'h9700; // LDI x7, 0x00 - Jump target for label: AOEC1
		10'h06A: instr_mem_out <= 16'h9002; // LDI x0, 0x02
		10'h06B: instr_mem_out <= 16'h6806; // COMPARE x6, x0
		10'h06C: instr_mem_out <= 16'h8068; // JMPEQ ADD_OUT_END
		10'h06D: instr_mem_out <= 16'h0000; // NOP
		10'h06E: instr_mem_out <= 16'h9005; // LDI x0, 0x05
		10'h06F: instr_mem_out <= 16'h80A3; // JMPEQ MUL_OUT_END
		10'h070: instr_mem_out <= 16'h0000; // NOP
		10'h071: instr_mem_out <= 16'h0000; // NOP
		10'h072: instr_mem_out <= 16'h0000; // NOP - Jump target for label: AOEC2
		10'h073: instr_mem_out <= 16'h3846; // JMP UART_OUT
		10'h074: instr_mem_out <= 16'h0000; // NOP
		10'h075: instr_mem_out <= 16'h0000; // NOP
		10'h076: instr_mem_out <= 16'h0000; // NOP
		10'h078: instr_mem_out <= 16'h0000; // NOP
		10'h079: instr_mem_out <= 16'h9045; // LDI x0, 0x45
		10'h07B: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03 - Jump target for label: AOEC3
		10'h07C: instr_mem_out <= 16'h0000; // NOP
		10'h07D: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h07E: instr_mem_out <= 16'h806A; // JMPEQ AOEC1
		10'h07F: instr_mem_out <= 16'h0000; // NOP
		10'h080: instr_mem_out <= 16'h0000; // NOP
		10'h081: instr_mem_out <= 16'h0000; // NOP
		10'h082: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h083: instr_mem_out <= 16'h904E; // LDI x0, 0x4E
		10'h085: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h086: instr_mem_out <= 16'h0000; // NOP
		10'h087: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h088: instr_mem_out <= 16'h8073; // JMPEQ AOEC2
		10'h089: instr_mem_out <= 16'h0000; // NOP
		10'h08A: instr_mem_out <= 16'h0000; // NOP
		10'h08B: instr_mem_out <= 16'h0000; // NOP
		10'h08C: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h08D: instr_mem_out <= 16'h9044; // LDI x0, 0x44 - Jump target for label: AOEC5
		10'h08F: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h090: instr_mem_out <= 16'h0000; // NOP
		10'h091: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h092: instr_mem_out <= 16'h807C; // JMPEQ AOEC3
		10'h093: instr_mem_out <= 16'h0000; // NOP
		10'h094: instr_mem_out <= 16'h0000; // NOP
		10'h095: instr_mem_out <= 16'h0000; // NOP
		10'h096: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01 - Jump target for label: AOEC6
		10'h097: instr_mem_out <= 16'h9041; // LDI x0, 0x41
		10'h099: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h09A: instr_mem_out <= 16'h0000; // NOP
		10'h09B: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h09C: instr_mem_out <= 16'h8085; // JMPEQ AOEC4
		...
		10'h0A3: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h0A4: instr_mem_out <= 16'h0000; // NOP - Jump target for label: MOEC1
		10'h0A5: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0A6: instr_mem_out <= 16'h808E; // JMPEQ AOEC5
		10'h0A7: instr_mem_out <= 16'h0000; // NOP
		10'h0A8: instr_mem_out <= 16'h0000; // NOP
		10'h0A9: instr_mem_out <= 16'h0000; // NOP
		10'h0AA: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h0AB: instr_mem_out <= 16'h9044; // LDI x0, 0x44
		10'h0AD: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03 - Jump target for label: MOEC2
		10'h0AE: instr_mem_out <= 16'h0000; // NOP
		10'h0AF: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0B0: instr_mem_out <= 16'h8097; // JMPEQ AOEC6
		10'h0B1: instr_mem_out <= 16'h0000; // NOP
		10'h0B2: instr_mem_out <= 16'h0000; // NOP
		10'h0B3: instr_mem_out <= 16'h0000; // NOP
		10'h0B4: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h0B5: instr_mem_out <= 16'h3846; // JMP UART_OUT
		10'h0B6: instr_mem_out <= 16'h0000; // NOP - Jump target for label: MOEC3
		10'h0B7: instr_mem_out <= 16'h0000; // NOP
		10'h0B8: instr_mem_out <= 16'h0000; // NOP
		10'h0BD: instr_mem_out <= 16'h0000; // NOP
		10'h0BE: instr_mem_out <= 16'h9045; // LDI x0, 0x45
		10'h0C0: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h0C1: instr_mem_out <= 16'h0000; // NOP
		10'h0C2: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0C3: instr_mem_out <= 16'h80A5; // JMPEQ MOEC1
		10'h0C4: instr_mem_out <= 16'h0000; // NOP
		10'h0C5: instr_mem_out <= 16'h0000; // NOP
		10'h0C6: instr_mem_out <= 16'h0000; // NOP
		10'h0C7: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h0C8: instr_mem_out <= 16'h904E; // LDI x0, 0x4E - Jump target for label: MOEC5
		10'h0CA: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h0CB: instr_mem_out <= 16'h0000; // NOP
		10'h0CC: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0CD: instr_mem_out <= 16'h80AE; // JMPEQ MOEC2
		10'h0CE: instr_mem_out <= 16'h0000; // NOP
		10'h0CF: instr_mem_out <= 16'h0000; // NOP
		10'h0D0: instr_mem_out <= 16'h0000; // NOP
		10'h0D1: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01 - Jump target for label: MOEC6
		10'h0D2: instr_mem_out <= 16'h9044; // LDI x0, 0x44
		10'h0D4: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h0D5: instr_mem_out <= 16'h0000; // NOP
		10'h0D6: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0D7: instr_mem_out <= 16'h80B7; // JMPEQ MOEC3
		...
		10'h0DC: instr_mem_out <= 16'h904D; // LDI x0, 0x4D
		10'h0DE: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h0DF: instr_mem_out <= 16'h0000; // NOP
		10'h0E0: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0E1: instr_mem_out <= 16'h80C0; // JMPEQ MOEC4
		10'h0E2: instr_mem_out <= 16'h0000; // NOP
		10'h0E3: instr_mem_out <= 16'h0000; // NOP
		10'h0E4: instr_mem_out <= 16'h0000; // NOP
		10'h0E5: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h0E6: instr_mem_out <= 16'h9055; // LDI x0, 0x55
		10'h0E8: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h0E9: instr_mem_out <= 16'h0000; // NOP
		10'h0EA: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0EB: instr_mem_out <= 16'h80C9; // JMPEQ MOEC5
		10'h0EC: instr_mem_out <= 16'h0000; // NOP
		10'h0ED: instr_mem_out <= 16'h0000; // NOP
		10'h0EE: instr_mem_out <= 16'h0000; // NOP
		10'h0EF: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h0F0: instr_mem_out <= 16'h904C; // LDI x0, 0x4C
		10'h0F2: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h0F3: instr_mem_out <= 16'h0000; // NOP
		10'h0F4: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h0F5: instr_mem_out <= 16'h80D2; // JMPEQ MOEC6
		10'h0F6: instr_mem_out <= 16'h0000; // NOP
		10'h0F7: instr_mem_out <= 16'h0000; // NOP
		10'h0F8: instr_mem_out <= 16'h0000; // NOP
		10'h0F9: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
