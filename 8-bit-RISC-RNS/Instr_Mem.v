/*
	Instruction memory module for source program call_ret.asm
...
always @(posedge clk) begin
	case (prog_ctr)
		...
		10'h005: instr_mem_out <= 16'h9700; // LDI x7, 0x00
		10'h006: instr_mem_out <= 16'h3825; // JMP ADD_LOOP ###Target address is bin 0000100101
		10'h007: instr_mem_out <= 16'h0000; // NOP
		10'h008: instr_mem_out <= 16'h0000; // NOP - Jump target for label: IT_MEM_UPPER
		10'h009: instr_mem_out <= 16'h0E16; // ADD x6, x6, x1
		10'h00A: instr_mem_out <= 16'h9700; // LDI x7, 0x00
		10'h00B: instr_mem_out <= 16'hF800; // JR RA
		10'h00C: instr_mem_out <= 16'h0000; // NOP
		10'h00D: instr_mem_out <= 16'h0000; // NOP - Jump target for label: STORE_TO_MEM
		10'h00E: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1
		10'h00F: instr_mem_out <= 16'h4B76; // RSTORE x3, x6, x7
		10'h010: instr_mem_out <= 16'h6857; // COMPARE x7, x5
		10'h011: instr_mem_out <= 16'h7815; // JMPLT STORE_RET ###Target address is bin 0000010101
		10'h012: instr_mem_out <= 16'h0000; // NOP
		10'h013: instr_mem_out <= 16'hF008; // CALL IT_MEM_UPPER ###Target address is bin 0000001000
		10'h014: instr_mem_out <= 16'h0000; // NOP
		10'h015: instr_mem_out <= 16'h0000; // NOP - Jump target for label: STORE_RET
		10'h016: instr_mem_out <= 16'hF800; // JR RA
		10'h017: instr_mem_out <= 16'h0000; // NOP
		10'h018: instr_mem_out <= 16'h0000; // NOP - Jump target for label: LOAD_FROM_MEM
		10'h019: instr_mem_out <= 16'h0F17; // ADD x7, x7, x1
		10'h01A: instr_mem_out <= 16'h4376; // RLOAD x3, x6, x7
		10'h01B: instr_mem_out <= 16'h6857; // COMPARE x7, x5
		10'h01C: instr_mem_out <= 16'h7820; // JMPLT LOAD_RET ###Target address is bin 0000100000
		10'h01D: instr_mem_out <= 16'h0000; // NOP
		10'h01E: instr_mem_out <= 16'hF008; // CALL IT_MEM_UPPER ###Target address is bin 0000001000
		10'h01F: instr_mem_out <= 16'h0000; // NOP
		10'h020: instr_mem_out <= 16'h0000; // NOP - Jump target for label: LOAD_RET
		10'h021: instr_mem_out <= 16'hF800; // JR RA
		10'h022: instr_mem_out <= 16'h0000; // NOP
		10'h023: instr_mem_out <= 16'h0000; // NOP
		10'h024: instr_mem_out <= 16'h0000; // NOP
		10'h025: instr_mem_out <= 16'h0000; // NOP - Jump target for label: ADD_LOOP
		10'h026: instr_mem_out <= 16'h98AA; // ADDM m0, m2, m2
		10'h027: instr_mem_out <= 16'h9A1A; // ADDM m2, m2, x1
		10'h028: instr_mem_out <= 16'hC308; // UNRLU x3, m0
		10'h029: instr_mem_out <= 16'hF00D; // CALL STORE_TO_MEM ###Target address is bin 0000001101
		10'h02A: instr_mem_out <= 16'h0000; // NOP
		10'h02B: instr_mem_out <= 16'h0000; // NOP
		10'h02C: instr_mem_out <= 16'hBB08; // UNRLL x3, m0
		10'h02D: instr_mem_out <= 16'hF00D; // CALL STORE_TO_MEM ###Target address is bin 0000001101
		10'h02E: instr_mem_out <= 16'h0000; // NOP
		10'h02F: instr_mem_out <= 16'h0000; // NOP
		10'h030: instr_mem_out <= 16'h9406; // LDI x4, 0x06
		10'h031: instr_mem_out <= 16'h6846; // COMPARE x6, x4
		10'h032: instr_mem_out <= 16'h7825; // JMPLT ADD_LOOP ###Target address is bin 0000100101
		10'h033: instr_mem_out <= 16'h0000; // NOP
		10'h034: instr_mem_out <= 16'h0A07; // ADD x2, x7, x0
		10'h035: instr_mem_out <= 16'h95FF; // LDI x5, 0xFF
		10'h036: instr_mem_out <= 16'h9600; // LDI x6, 0x00
		10'h037: instr_mem_out <= 16'h9700; // LDI x7, 0x00
		10'h038: instr_mem_out <= 16'h0000; // NOP - Jump target for label: UART_OUT
		10'h039: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h03A: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h03B: instr_mem_out <= 16'h8038; // JMPEQ UART_OUT ###Target address is bin 0000111000
		10'h03C: instr_mem_out <= 16'h0000; // NOP
		10'h03D: instr_mem_out <= 16'hF018; // CALL LOAD_FROM_MEM ###Target address is bin 0000011000
		10'h03E: instr_mem_out <= 16'h0000; // NOP
		10'h03F: instr_mem_out <= 16'h0000; // NOP
		10'h040: instr_mem_out <= 16'hD301; // OUTPUT x3, 0x01
		10'h041: instr_mem_out <= 16'h9406; // LDI x4, 0x06
		10'h042: instr_mem_out <= 16'h6846; // COMPARE x6, x4
		10'h043: instr_mem_out <= 16'h7838; // JMPLT UART_OUT ###Target address is bin 0000111000
		10'h044: instr_mem_out <= 16'h0000; // NOP
		10'h045: instr_mem_out <= 16'h0000; // NOP - Jump target for label: ADD_OUT_END
		10'h046: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h047: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h048: instr_mem_out <= 16'h8045; // JMPEQ ADD_OUT_END ###Target address is bin 0001000101
		10'h049: instr_mem_out <= 16'h0000; // NOP
		10'h04A: instr_mem_out <= 16'h6827; // COMPARE x7, x2
		10'h04B: instr_mem_out <= 16'h7053; // JMPGT ADD_OUT_PRINT ###Target address is bin 0001010011
		10'h04C: instr_mem_out <= 16'h0000; // NOP
		10'h04D: instr_mem_out <= 16'hF018; // CALL LOAD_FROM_MEM ###Target address is bin 0000011000
		10'h04E: instr_mem_out <= 16'h0000; // NOP
		10'h04F: instr_mem_out <= 16'h0000; // NOP
		10'h050: instr_mem_out <= 16'hD301; // OUTPUT x3, 0x01
		10'h051: instr_mem_out <= 16'h3845; // JMP ADD_OUT_END ###Target address is bin 0001000101
		10'h052: instr_mem_out <= 16'h0000; // NOP
		10'h053: instr_mem_out <= 16'h0000; // NOP - Jump target for label: ADD_OUT_PRINT
		10'h054: instr_mem_out <= 16'h9045; // LDI x0, 0x45
		10'h055: instr_mem_out <= 16'h0000; // NOP - Jump target for label: AOEC1
		10'h056: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h057: instr_mem_out <= 16'h0000; // NOP
		10'h058: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h059: instr_mem_out <= 16'h8055; // JMPEQ AOEC1 ###Target address is bin 0001010101
		10'h05A: instr_mem_out <= 16'h0000; // NOP
		10'h05B: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h05C: instr_mem_out <= 16'h904E; // LDI x0, 0x4E
		10'h05D: instr_mem_out <= 16'h0000; // NOP - Jump target for label: AOEC2
		10'h05E: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h05F: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h060: instr_mem_out <= 16'h805D; // JMPEQ AOEC2 ###Target address is bin 0001011101
		10'h061: instr_mem_out <= 16'h0000; // NOP
		10'h062: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h063: instr_mem_out <= 16'h9044; // LDI x0, 0x44
		10'h064: instr_mem_out <= 16'h0000; // NOP - Jump target for label: AOEC3
		10'h065: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h066: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h067: instr_mem_out <= 16'h8064; // JMPEQ AOEC3 ###Target address is bin 0001100100
		10'h068: instr_mem_out <= 16'h0000; // NOP
		10'h069: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h06A: instr_mem_out <= 16'h9041; // LDI x0, 0x41
		10'h06B: instr_mem_out <= 16'h0000; // NOP - Jump target for label: AOEC4
		10'h06C: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h06D: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h06E: instr_mem_out <= 16'h806B; // JMPEQ AOEC4 ###Target address is bin 0001101011
		10'h06F: instr_mem_out <= 16'h0000; // NOP
		10'h070: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h071: instr_mem_out <= 16'h9044; // LDI x0, 0x44
		10'h072: instr_mem_out <= 16'h0000; // NOP - Jump target for label: AOEC5
		10'h073: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h074: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h075: instr_mem_out <= 16'h8072; // JMPEQ AOEC5 ###Target address is bin 0001110010
		10'h076: instr_mem_out <= 16'h0000; // NOP
		10'h077: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h078: instr_mem_out <= 16'h9044; // LDI x0, 0x44
		10'h079: instr_mem_out <= 16'h0000; // NOP - Jump target for label: AOEC6
		10'h07A: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h07B: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h07C: instr_mem_out <= 16'h8079; // JMPEQ AOEC6 ###Target address is bin 0001111001
		10'h07D: instr_mem_out <= 16'h0000; // NOP
		10'h07E: instr_mem_out <= 16'hD001; // OUTPUT x0, 0x01
		10'h07F: instr_mem_out <= 16'h0000; // NOP
		10'h080: instr_mem_out <= 16'h0000; // NOP - Jump target for label: UART_ECHO
		10'h081: instr_mem_out <= 16'hDC02; // INPUT x4, 0x02
		10'h082: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h083: instr_mem_out <= 16'h7880; // JMPLT UART_ECHO ###Target address is bin 0010000000
		10'h084: instr_mem_out <= 16'h0000; // NOP
		10'h085: instr_mem_out <= 16'hDA01; // INPUT x2, 0x01
		10'h086: instr_mem_out <= 16'h0000; // NOP
		10'h087: instr_mem_out <= 16'h0000; // NOP - Jump target for label: UART_ECHO_CHECK
		10'h088: instr_mem_out <= 16'hDC03; // INPUT x4, 0x03
		10'h089: instr_mem_out <= 16'h6814; // COMPARE x4, x1
		10'h08A: instr_mem_out <= 16'h8087; // JMPEQ UART_ECHO_CHECK ###Target address is bin 0010000111
		10'h08B: instr_mem_out <= 16'h0000; // NOP
		10'h08C: instr_mem_out <= 16'hD201; // OUTPUT x2, 0x01
		10'h08D: instr_mem_out <= 16'h3880; // JMP UART_ECHO ###Target address is bin 0010000000
